...
public:
    cRespirador(cPreventivo* preventivo, cCorrectivo* correctivo, int altura, int peso, string codigo, string descripcion, cListaFechas* fechaMant, lugar lugarGuarda);
    ~cRespirador();
