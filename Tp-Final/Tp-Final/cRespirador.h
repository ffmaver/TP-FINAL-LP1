...
public:
    cRespirador(int flujoConfig, cMantenimiento* preventivo, cMantenimiento* correctivo, int altura, int peso, string codigo, string descripcion, estado eestado, string lugarAct, string lugarGuarda, int costoMantenimiento, cFecha** fechasMant);
    ~cRespirador();
